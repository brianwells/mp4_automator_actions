...
@interface Add_MPEG_4_Metadata_Tags : AMBundleAction < NSTokenFieldDelegate >
{
	...
	IBOutlet NSTokenField *indexTokenField;
	IBOutlet NSTokenField *totalTokenField;
